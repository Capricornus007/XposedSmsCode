...
paths_file="${2:-}"
full_tasks=( :core:check :runtime:check :app:check :smscode-core:contract:testDebugUnitTest :smscode-core:domain:testDebugUnitTest :smscode-core:hook:testDebugUnitTest :smscode-core:runtime:testDebugUnitTest :smscode-core:verification:detekt :smscode-core:verification:testDebugUnitTest :magisk-xposed-kit:testDebugUnitTest :magisk-xposed-kit:logging:testDebugUnitTest :magisk-xposed-kit:diagnostics:testDebugUnitTest :app:compileGithubDebugAndroidTestKotlin :app:compilePlayDebugAndroidTestKotlin :core:compilePlayDebugUnitTestKotlin :core:generatePlayDebugUnitTestStubRFile :runtime:compileDebugAndroidTestKotlin :app:koverVerifyGithubDebug :app:koverHtmlReportGithubDebug )
...
while IFS= read -r path; do
  ...
  case "$path" in
    ...
    smscode/*) select_task :smscode-core:contract:testDebugUnitTest; select_task :smscode-core:domain:testDebugUnitTest; select_task :smscode-core:hook:testDebugUnitTest; select_task :smscode-core:runtime:testDebugUnitTest; select_task :smscode-core:verification:detekt; select_task :smscode-core:verification:testDebugUnitTest ;;
