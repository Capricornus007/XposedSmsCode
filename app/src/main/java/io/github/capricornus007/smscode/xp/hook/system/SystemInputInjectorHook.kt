package io.github.capricornus007.smscode.xp.hook.system
...
class SystemInputInjectorHook : BaseHook() {
    ...
    private fun registerReceiver(context: Context) {
        try {
            ...
            val filter = IntentFilter("io.github.capricornus007.smscode.ACTION_AUTO_INPUT")
    ...
    companion object {
        ...
        @Suppress("unused")
        const val ACTION_AUTO_INPUT = "io.github.capricornus007.smscode.ACTION_AUTO_INPUT"
    }
}
