package io.github.capricornus007.smscode.data.update
...
class GithubUpdateCheckerTest {
    ...
    fun parseLatestReleaseJson_parsesVersionAndUrl() {
        val json = """{"tag_name":"v3.1.1","html_url":"https://github.com/Capricornus007/xposedsmscode/releases/tag/v3.1.1"}"""
        ...
        assertEquals(
            "https://github.com/Capricornus007/xposedsmscode/releases/tag/v3.1.1",
            release?.htmlUrl,
        )
    }
    ...
    fun parseLatestReleaseJson_usesFallbackUrlWhenMissing() {
        ...
        assertNotNull(release)
        assertEquals("3.1.1", release?.versionName)
        assertEquals("https://github.com/Capricornus007/xposedsmscode/releases/latest", release?.htmlUrl)
    }
    ...
    fun fetchLatestReleaseWithRequester_returnsParsedReleaseOnSuccess() {
        val release = kotlinx.coroutines.runBlocking {
            GithubUpdateChecker.fetchLatestReleaseWithRequester {
                """{"tag_name":"v9.9.9","html_url":"https://github.com/Capricornus007/xposedsmscode/releases/tag/v9.9.9"}"""
            }
        }
        assertNotNull(release)
        ...
        val json = """
            {
              "versionCode": 31800,
              "versionName": "3.1.8",
              "htmlUrl": "https://github.com/Capricornus007/xposedsmscode/releases/tag/v3.1.8",
              "changelog": "fixes",
